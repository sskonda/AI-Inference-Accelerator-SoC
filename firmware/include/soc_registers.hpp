...
inline constexpr unsigned DEFAULT_MAX_GEMM_M = 8U;
inline constexpr unsigned DEFAULT_MAX_GEMM_N = 8U;
inline constexpr unsigned DEFAULT_MAX_GEMM_K = 8U;
inline constexpr unsigned DEFAULT_GEMM_TILE_M = 4U;
inline constexpr unsigned DEFAULT_GEMM_TILE_N = 4U;
