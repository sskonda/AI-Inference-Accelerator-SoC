module vector_test_top #(
  ...
  input  logic [    accel_pkg::LENGTH_WIDTH-1:0] command_length,
  input  logic [     accel_pkg::FLAGS_WIDTH-1:0] command_flags,
  input  logic [  accel_pkg::PRIORITY_WIDTH-1:0] command_priority,
  ...
  always_comb begin
    ...
    command.priority_level = command_priority;
